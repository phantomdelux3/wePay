...
export function Inputbox({title,placeholder}) {
  return (
    <div className='pb-1 flex relative mb-5 '>
      <input type="text" required className='w-full px-3 pb-1 my-1 border-b border-royale-yellow bg-[rgba(0,0,0,0)] focus:text-lylac focus:border-lylac focus:font-bold focus:outline-none  focus:border-b-2 transition-colors duration-500 peer'/>
